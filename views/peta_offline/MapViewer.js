  ...
  return (
    <View style={styles.screen}>
      ...
      <View style={styles.mapContainer}>
        ...
        {/* Tombol Pusatkan Posisi GPS (di kanan atas di bawah tombol layer) */}
        <TouchableOpacity
          style={styles.myLocBtn}
          onPress={flyToMyLocation}
          activeOpacity={0.7}
          accessibilityLabel="Pusatkan Posisi GPS"
        >
          <View style={styles.targetOuterRing}>
            <View style={styles.targetInnerDot} />
            <View style={[styles.targetCrosshair, styles.targetCrosshairH]} />
            <View style={[styles.targetCrosshair, styles.targetCrosshairV]} />
          </View>
        </TouchableOpacity>
      </View>
...
const styles = StyleSheet.create({
  ...
  // Navigation HUD
  navHud: {
    position: 'absolute', top: 64, left: 12, right: 66,
    backgroundColor: 'rgba(15, 23, 42, 0.95)', borderRadius: 14,
    padding: 10, borderWidth: 1, borderColor: '#10B981',
    elevation: 8, shadowColor: '#000', shadowOpacity: 0.4, shadowRadius: 10,
  },
  ...
  myLocBtn: {
    position: 'absolute', top: 64, right: 14, width: 44, height: 44,
    backgroundColor: 'rgba(15, 23, 42, 0.94)', borderRadius: 22,
    alignItems: 'center', justifyContent: 'center',
    borderWidth: 1.5, borderColor: '#38BDF8',
    elevation: 8, shadowColor: '#000', shadowOpacity: 0.35, shadowOffset: { width: 0, height: 4 }, shadowRadius: 6,
  },
  targetOuterRing: {
  ...
  targetCrosshair: {
    position: 'absolute', backgroundColor: '#38BDF8',
  },
  targetCrosshairH: {
    width: 26, height: 1.5, top: 7.25, left: -5,
  },
  targetCrosshairV: {
    width: 1.5, height: 26, top: -5, left: 7.25,
  },
